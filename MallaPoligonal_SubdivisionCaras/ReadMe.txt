========================================================================
    APLICACIÓN DE CONSOLA: MallaPoligonal_SubdivisionCaras Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación MallaPoligonal_SubdivisionCaras.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación MallaPoligonal_SubdivisionCaras.


MallaPoligonal_SubdivisionCaras.vcxproj
...
MallaPoligonal_SubdivisionCaras.vcxproj.filters
...
MallaPoligonal_SubdivisionCaras.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado MallaPoligonal_SubdivisionCaras.pch y un archivo de tipos precompilados llamado StdAfx.obj.
